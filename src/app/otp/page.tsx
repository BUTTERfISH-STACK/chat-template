    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md">
        ...
        <div className="card-premium animate-slide-up">
          ...
          {/* Dev OTP Display */}
          {devOtp && (
            <div className="mb-4 p-3 rounded-lg bg-yellow-500/10 border border-yellow-500/20 text-yellow-500 text-sm text-center animate-pulse">
          ...
          <div className="mt-6 pt-6 border-t border-border">
            ...
            <div className="flex gap-2 justify-center flex-wrap">
              {(['whatsapp', 'sms', 'totp'] as DeliveryMethod[]).map((m) => (
                <button
                  key={m}
                  onClick={() => handleSendOTP(m)}
