        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="p-4">
            ...
            <div className="flex gap-4 mb-6">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${
                  selectedTab === "post" ? "bg-[var(--secondary)]" : "hover:bg-[var(--secondary)]/50"
                }`}
              >
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${
                  selectedTab === "reel" ? "bg-[var(--secondary)]" : "hover:bg-[var(--secondary)]/50"
                }`}
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${
                  selectedTab === "story" ? "bg-[var(--secondary)]" : "hover:bg-[var(--secondary)]/50"
                }`}
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-6">
              ...
              <textarea
                className="w-full px-4 py-3 bg-[var(--background)] rounded-lg border border-[var(--border)] 
                         focus:outline-none focus:border-[var(--primary)] transition-all duration-200 
            ...
            <div className="mt-4">
              ...
              <div className="flex items-center gap-2 px-4 py-3 bg-[var(--secondary)] rounded-lg border border-[var(--border)]">
