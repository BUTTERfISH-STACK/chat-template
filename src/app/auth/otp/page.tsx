...
export default function OTPVerificationPage() {
  ...
  const { login } = useAuth();
  const [otp, setOtp] = useState("588574"); // Pre-filled for testing
  ...
  useEffect(() => {
    ...
    if (storedPhoneNumber) {
      ...
      // For testing purposes, use a default phone number if none is stored
      const defaultPhoneNumber = "+1234567890";
      setPhoneNumber(defaultPhoneNumber);
      sessionStorage.setItem("phoneNumber", defaultPhoneNumber);
    }
  }, [router]);
